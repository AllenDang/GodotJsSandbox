...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "MultiplayerAPIExtension: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "MultiplayerAPIExtension: unknown error"); \
    }


// Registration function for MultiplayerAPIExtension
void register_MultiplayerAPIExtension_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "MultiplayerAPIExtension", class_info);
}
