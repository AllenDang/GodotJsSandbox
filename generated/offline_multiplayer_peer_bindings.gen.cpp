...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OfflineMultiplayerPeer: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OfflineMultiplayerPeer: unknown error"); \
    }


// Registration function for OfflineMultiplayerPeer
void register_OfflineMultiplayerPeer_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "OfflineMultiplayerPeer", class_info);
}
