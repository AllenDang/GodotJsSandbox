...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OpenXRHapticBase: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OpenXRHapticBase: unknown error"); \
    }


// Registration function for OpenXRHapticBase
void register_OpenXRHapticBase_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "OpenXRHapticBase", class_info);
}
