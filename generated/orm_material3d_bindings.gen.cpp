...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "ORMMaterial3D: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "ORMMaterial3D: unknown error"); \
    }


// Registration function for ORMMaterial3D
void register_ORMMaterial3D_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "ORMMaterial3D", class_info);
}
