...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OpenXRIPBindingModifier: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OpenXRIPBindingModifier: unknown error"); \
    }


// Registration function for OpenXRIPBindingModifier
void register_OpenXRIPBindingModifier_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "OpenXRIPBindingModifier", class_info);
}
