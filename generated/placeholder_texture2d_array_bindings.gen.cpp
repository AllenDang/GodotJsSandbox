...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "PlaceholderTexture2DArray: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "PlaceholderTexture2DArray: unknown error"); \
    }


// Registration function for PlaceholderTexture2DArray
void register_PlaceholderTexture2DArray_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, class_info, "parent", JS_NewString(ctx, "PlaceholderTextureLayered"));
    ...
    JS_SetPropertyStr(ctx, classes, "PlaceholderTexture2DArray", class_info);
}
