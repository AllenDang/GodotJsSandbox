...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "RDShaderSPIRV: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "RDShaderSPIRV: unknown error"); \
    }


// Registration function for RDShaderSPIRV
void register_RDShaderSPIRV_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "RDShaderSPIRV", class_info);
}
