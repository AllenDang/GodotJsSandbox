...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "PlaceholderMaterial: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "PlaceholderMaterial: unknown error"); \
    }


// Registration function for PlaceholderMaterial
void register_PlaceholderMaterial_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "PlaceholderMaterial", class_info);
}
