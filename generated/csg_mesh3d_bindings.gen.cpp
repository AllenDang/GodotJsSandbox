...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "CSGMesh3D: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "CSGMesh3D: unknown error"); \
    }


// Registration function for CSGMesh3D
void register_CSGMesh3D_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "CSGMesh3D", class_info);
}
