...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "CheckButton: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "CheckButton: unknown error"); \
    }


// Registration function for CheckButton
void register_CheckButton_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "CheckButton", class_info);
}
