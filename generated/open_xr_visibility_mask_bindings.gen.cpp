...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OpenXRVisibilityMask: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OpenXRVisibilityMask: unknown error"); \
    }


// Registration function for OpenXRVisibilityMask
void register_OpenXRVisibilityMask_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "OpenXRVisibilityMask", class_info);
}
