...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "TextureCubemapRD: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "TextureCubemapRD: unknown error"); \
    }


// Registration function for TextureCubemapRD
void register_TextureCubemapRD_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "TextureCubemapRD", class_info);
}
