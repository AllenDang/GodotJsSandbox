...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "LightmapProbe: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "LightmapProbe: unknown error"); \
    }


// Registration function for LightmapProbe
void register_LightmapProbe_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "LightmapProbe", class_info);
}
