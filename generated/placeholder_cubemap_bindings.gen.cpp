...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "PlaceholderCubemap: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "PlaceholderCubemap: unknown error"); \
    }


// Registration function for PlaceholderCubemap
void register_PlaceholderCubemap_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "PlaceholderCubemap", class_info);
}
