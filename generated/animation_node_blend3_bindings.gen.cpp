...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "AnimationNodeBlend3: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "AnimationNodeBlend3: unknown error"); \
    }


// Registration function for AnimationNodeBlend3
void register_AnimationNodeBlend3_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "AnimationNodeBlend3", class_info);
}
