...
static JSValue js_NavigationPathQueryResult3D_reset(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.reset: write rate limit exceeded");
    }
...
static JSValue js_NavigationPathQueryResult3D_set_path(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.path setter: write rate limit exceeded");
    }
...
static JSValue js_NavigationPathQueryResult3D_set_path_types(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.path_types setter: write rate limit exceeded");
    }
...
static JSValue js_NavigationPathQueryResult3D_set_path_rids(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.path_rids setter: write rate limit exceeded");
    }
...
static JSValue js_NavigationPathQueryResult3D_set_path_owner_ids(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.path_owner_ids setter: write rate limit exceeded");
    }
...
static JSValue js_NavigationPathQueryResult3D_set_path_length(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "NavigationPathQueryResult3D.path_length setter: write rate limit exceeded");
    }
