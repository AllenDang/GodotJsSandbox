...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "MultiplayerPeerExtension: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "MultiplayerPeerExtension: unknown error"); \
    }


// Registration function for MultiplayerPeerExtension
void register_MultiplayerPeerExtension_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "MultiplayerPeerExtension", class_info);
}
