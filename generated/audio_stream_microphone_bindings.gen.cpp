...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "AudioStreamMicrophone: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "AudioStreamMicrophone: unknown error"); \
    }


// Registration function for AudioStreamMicrophone
void register_AudioStreamMicrophone_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "AudioStreamMicrophone", class_info);
}
