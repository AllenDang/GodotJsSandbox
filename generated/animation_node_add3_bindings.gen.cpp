...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "AnimationNodeAdd3: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "AnimationNodeAdd3: unknown error"); \
    }


// Registration function for AnimationNodeAdd3
void register_AnimationNodeAdd3_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "AnimationNodeAdd3", class_info);
}
