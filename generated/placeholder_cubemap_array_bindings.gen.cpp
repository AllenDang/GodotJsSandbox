...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "PlaceholderCubemapArray: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "PlaceholderCubemapArray: unknown error"); \
    }


// Registration function for PlaceholderCubemapArray
void register_PlaceholderCubemapArray_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "PlaceholderCubemapArray", class_info);
}
