...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "HBoxContainer: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "HBoxContainer: unknown error"); \
    }


// Registration function for HBoxContainer
void register_HBoxContainer_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "HBoxContainer", class_info);
}
