...
static JSValue js_CurveXYZTexture_set_width(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "CurveXYZTexture.width setter: write rate limit exceeded");
    }
...
static JSValue js_CurveXYZTexture_set_curve_x(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "CurveXYZTexture.curve_x setter: write rate limit exceeded");
    }
...
static JSValue js_CurveXYZTexture_set_curve_y(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "CurveXYZTexture.curve_y setter: write rate limit exceeded");
    }
...
static JSValue js_CurveXYZTexture_set_curve_z(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "CurveXYZTexture.curve_z setter: write rate limit exceeded");
    }
