...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OpenXRAction: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OpenXRAction: unknown error"); \
    }

// Property getter: OpenXRAction::localized_name
static JSValue js_OpenXRAction_get_localized_name(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 1) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name getter: missing handle");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name getter: invalid handle");
    }
    ...
    if (!obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name getter: invalid object");
    }

    OpenXRAction* typed_obj = Object::cast_to<OpenXRAction>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name getter: wrong type");
    }
...
// Property setter: OpenXRAction::localized_name
static JSValue js_OpenXRAction_set_localized_name(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 2) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name setter: missing arguments");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name setter: invalid handle");
    }
    ...
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "OpenXRAction.localized_name setter: write rate limit exceeded");
    }

    Object* obj = qjs_ctx->get_object_registry()->get_object(handle);
    if (!obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name setter: invalid object");
    }

    OpenXRAction* typed_obj = Object::cast_to<OpenXRAction>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.localized_name setter: wrong type");
    }
...
// Property getter: OpenXRAction::action_type
static JSValue js_OpenXRAction_get_action_type(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 1) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type getter: missing handle");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type getter: invalid handle");
    }
    ...
    Object* obj = qjs_ctx->get_object_registry()->get_object(handle);
    if (!obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type getter: invalid object");
    }

    OpenXRAction* typed_obj = Object::cast_to<OpenXRAction>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type getter: wrong type");
    }

    int64_t value = typed_obj->get_action_type();
    return JS_NewInt64(ctx, value);
}

// Property setter: OpenXRAction::action_type
static JSValue js_OpenXRAction_set_action_type(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 2) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type setter: missing arguments");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type setter: invalid handle");
    }
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "OpenXRAction.action_type setter: write rate limit exceeded");
    }

    Object* obj = qjs_ctx->get_object_registry()->get_object(handle);
    if (!obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type setter: invalid object");
    }

    OpenXRAction* typed_obj = Object::cast_to<OpenXRAction>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "OpenXRAction.action_type setter: wrong type");
    }

    int64_t value; JS_ToInt64(ctx, &value, argv[1]);
    typed_obj->set_action_type((OpenXRAction::ActionType)value);
    return JS_UNDEFINED;
}
...
static JSValue js_OpenXRAction_set_toplevel_paths(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    ...
    ExecutionLimiter* limiter = qjs_ctx->get_execution_limiter();
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "OpenXRAction.toplevel_paths setter: write rate limit exceeded");
    }
...
void register_OpenXRAction_bindings(JSContext* ctx, JSValue global, JSValue classes) {
...

    {
        ...
        JS_SetPropertyStr(ctx, prop_obj, "get",
            JS_NewCFunction(ctx, js_OpenXRAction_get_localized_name, "get_localized_name", 1));
        JS_SetPropertyStr(ctx, prop_obj, "set",
            JS_NewCFunction(ctx, js_OpenXRAction_set_localized_name, "set_localized_name", 2));
        JS_SetPropertyStr(ctx, props, "localized_name", prop_obj);
    }
    {
        JSValue prop_obj = JS_NewObject(ctx);
        JS_SetPropertyStr(ctx, prop_obj, "get",
            JS_NewCFunction(ctx, js_OpenXRAction_get_action_type, "get_action_type", 1));
        JS_SetPropertyStr(ctx, prop_obj, "set",
    ...
    JS_SetPropertyStr(ctx, classes, "OpenXRAction", class_info);
}
