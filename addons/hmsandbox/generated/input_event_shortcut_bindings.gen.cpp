...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "InputEventShortcut: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "InputEventShortcut: unknown error"); \
    }

// Property getter: InputEventShortcut::shortcut
static JSValue js_InputEventShortcut_get_shortcut(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 1) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut getter: missing handle");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut getter: invalid handle");
    }
    ...
    if (!obj) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut getter: invalid object");
    }

    InputEventShortcut* typed_obj = Object::cast_to<InputEventShortcut>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut getter: wrong type");
    }
...
// Property setter: InputEventShortcut::shortcut
static JSValue js_InputEventShortcut_set_shortcut(JSContext* ctx, JSValueConst this_val, int argc, JSValueConst* argv) {
    if (argc < 2) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut setter: missing arguments");
    }

    int64_t handle;
    if (JS_ToInt64(ctx, &handle, argv[0]) < 0) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut setter: invalid handle");
    }
    ...
    if (limiter && !limiter->check_api_rate_limit(ApiCategory::WRITE)) {
        return JS_ThrowInternalError(ctx, "InputEventShortcut.shortcut setter: write rate limit exceeded");
    }

    Object* obj = qjs_ctx->get_object_registry()->get_object(handle);
    if (!obj) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut setter: invalid object");
    }

    InputEventShortcut* typed_obj = Object::cast_to<InputEventShortcut>(obj);
    if (!typed_obj) {
        return JS_ThrowTypeError(ctx, "InputEventShortcut.shortcut setter: wrong type");
    }
...
// Registration function for InputEventShortcut
void register_InputEventShortcut_bindings(JSContext* ctx, JSValue global, JSValue classes) {
...

    {
        ...
        JS_SetPropertyStr(ctx, prop_obj, "get",
            JS_NewCFunction(ctx, js_InputEventShortcut_get_shortcut, "get_shortcut", 1));
        JS_SetPropertyStr(ctx, prop_obj, "set",
            JS_NewCFunction(ctx, js_InputEventShortcut_set_shortcut, "set_shortcut", 2));
    ...
    JS_SetPropertyStr(ctx, classes, "InputEventShortcut", class_info);
}
