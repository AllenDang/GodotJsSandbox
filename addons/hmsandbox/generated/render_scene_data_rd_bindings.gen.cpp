...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "RenderSceneDataRD: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "RenderSceneDataRD: unknown error"); \
    }


// Registration function for RenderSceneDataRD
void register_RenderSceneDataRD_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "RenderSceneDataRD", class_info);
}
