...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "AnimationNodeAdd2: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "AnimationNodeAdd2: unknown error"); \
    }


// Registration function for AnimationNodeAdd2
void register_AnimationNodeAdd2_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "AnimationNodeAdd2", class_info);
}
