...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "CompressedCubemapArray: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "CompressedCubemapArray: unknown error"); \
    }


// Registration function for CompressedCubemapArray
void register_CompressedCubemapArray_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "CompressedCubemapArray", class_info);
}
