...
#define SAFE_METHOD_CALL(code) \
    try { \
        ...
        return JS_ThrowInternalError(ctx, "OpenXRBindingModifier: %s", e.what()); \
    } catch (...) { \
        return JS_ThrowInternalError(ctx, "OpenXRBindingModifier: unknown error"); \
    }


// Registration function for OpenXRBindingModifier
void register_OpenXRBindingModifier_bindings(JSContext* ctx, JSValue global, JSValue classes) {
    ...
    JS_SetPropertyStr(ctx, classes, "OpenXRBindingModifier", class_info);
}
