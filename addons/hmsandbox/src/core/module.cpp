...
extern "C"
{
    GDExtensionBool GDE_EXPORT godot_js_runtime_library_init(GDExtensionInterfaceGetProcAddress p_get_proc_address, const GDExtensionClassLibraryPtr p_library,
